...
const cachedViewNames = ['StockQuery', 'TxList', 'Warnings', 'PcAssets', 'MonitorAssets', 'AssetOwnership', 'PcAgeWarnings', 'PcTx', 'MonitorTx', 'PcInventoryLogs', 'MonitorInventoryLogs'];
