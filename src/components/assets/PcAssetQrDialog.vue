    ...
    <template #header>
      <div class="qr-header">
        <div class="qr-header__intro">
          <div class="qr-header__eyebrow">PC QR CODE</div>
          <div class="qr-header__title">扫码查看电脑信息</div>
          <div class="qr-header__desc">可控长期码 · 信息实时更新</div>
        </div>
        <el-tag
          v-if="row"
    ...
    >
        ...
        <div class="qr-preview-card">
          ...
          >
            <div class="qr-meta-item">
              <span class="qr-meta-label">SN</span>
              <span class="qr-meta-value">{{ row.serial_no || '-' }}</span>
            </div>
            <div class="qr-meta-item">
              <span class="qr-meta-label">状态</span>
              <span class="qr-meta-value">{{ currentStatusText }}</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <aside class="qr-tool-panel">
        ...
        <section class="qr-tip-card">
          ...
          <div>
            <div class="qr-tip-card__title">提示</div>
            <div class="qr-tip-card__text">
              修改台账/出入库后，扫码会自动展示最新数据；管理员重置二维码后旧码立即失效。
            </div>
          </div>
        </section>
      </aside>
    ...
    <template #footer>
      <div class="qr-footer">
        <div class="qr-footnote">
          建议打印标签时选择“实际大小100%”，二维码边长 ≥ 25mm 更易识别。
        </div>
