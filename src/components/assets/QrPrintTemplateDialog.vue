...
.section-title{font-size:13px;font-weight:700;color:var(--ink-secondary);margin:8px 0 12px}
...
.preview-text-line.strong{width:78%;height:9px;background:var(--subtle)}
