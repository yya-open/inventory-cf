...
async function queueExport() {
  try {
    ...
    const request_json = Object.fromEntries(params.entries());
    const r:any = await apiPost('/api/jobs', { job_type: 'MONITOR_INVENTORY_LOG_EXPORT', permission_scope: 'async_job_manage', request_json, retain_days: 7, max_retries: 1 });
