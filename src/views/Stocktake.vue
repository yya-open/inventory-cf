...
.detail-row-pending td{background:var(--surface-soft) !important}
.detail-row-increase td{background:var(--success-tint) !important}
.detail-row-decrease td{background:var(--danger-tint) !important}
