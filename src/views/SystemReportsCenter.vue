...
<style scoped>
.system-reports-center{display:flex;flex-direction:column;gap:14px}.hero-card{border-radius:var(--radius-md)}.hero-head{display:flex;justify-content:space-between;align-items:flex-start;gap:12px;flex-wrap:wrap;margin-bottom:12px}.hero-title{font-size:20px;font-weight:800}.hero-desc,.section-desc{font-size:13px;color:var(--muted);margin-top:4px}.hero-actions,.section-actions{display:flex;gap:8px;flex-wrap:wrap;justify-content:flex-end}.quick-card{cursor:pointer;border-radius:var(--radius-md);min-height:116px}.quick-title{font-size:16px;font-weight:700;margin-bottom:8px}.quick-desc{font-size:13px;color:var(--muted);line-height:1.5}.snapshot-card{border-radius:var(--radius-md)}.snapshot-head{display:flex;justify-content:space-between;gap:12px;align-items:flex-start;flex-wrap:wrap;margin-bottom:8px}.snapshot-meta{font-size:12px;color:var(--muted)}.section-header{display:flex;justify-content:space-between;align-items:center;gap:12px;flex-wrap:wrap}.section-header.compact{align-items:flex-start}.section-title{font-size:16px;font-weight:700}.summary-row{margin:0}.summary-card,.insight-card{border-radius:var(--radius-md)}.summary-label{font-size:12px;color:var(--muted)}.summary-value{font-size:28px;font-weight:800;margin-top:6px}.insight-row{margin:0}.insight-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}.insight-item{padding:12px;border:1px solid var(--border-soft);border-radius:var(--radius-md);background:var(--surface-soft);display:flex;justify-content:space-between;gap:12px}.insight-k{font-size:12px;color:var(--muted)}.entry-list{display:grid;gap:6px;justify-items:start}.dashboard-placeholder,.dashboard-skeleton{padding:8px 0}@media (max-width:768px){.hero-actions{justify-content:flex-start}.insight-grid{grid-template-columns:1fr}}
</style>
